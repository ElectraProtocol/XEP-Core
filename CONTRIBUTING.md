...
First, in terms of structure, there is no particular concept of "XEP Core
...
Before you start contributing, familiarize yourself with the XEP Core build
system and tests. Refer to the documentation in the repository on how to build
XEP Core and how to run the unit tests, functional tests, and fuzz tests.
...
[XEP Core PR Review Club](https://xepcore.reviews/) meeting.
...
For GUI-related issues or pull requests, the https://github.com/xep-core/gui repository should be used.
...
fork of XEP Core copies the merge. Instead, make any username mentions in a
