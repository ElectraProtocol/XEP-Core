...
- [Main thread (`xepd`)](https://doxygen.bitcoincore.org/xepd_8cpp.html#a0ddf1224851353fc92bfbff6f499fa97)
  : Started from `main()` in `xepd.cpp`. Responsible for starting up and
