...
It is possible to run XEP Core as a Tor onion service, and connect to such services.
...
XEP Core automatically creates an onion service to listen on. This will positively
...
- Do not add anything but XEP Core ports to the onion service created in section 2.
