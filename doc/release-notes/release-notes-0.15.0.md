...
- `uptime` returns the total runtime of the `xepd` server since its last start (See [PR 10400](https://github.com/bitcoin/bitcoin/pull/10400)).
...
- #10651 `cef4b5c` Verify binaries from bitcoincore.org and xep.org (TheBlueMatt)
