...
# Deterministically build XEP Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/xep/' to
        #     '/home/satoshi/xep/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/xep
        #
        #                     maps our current working directory to /xep
        ...
        #     container so that we have something to build. '/xep' was
        #     chosen arbitrarily.
        #
