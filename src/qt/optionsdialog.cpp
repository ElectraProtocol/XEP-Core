...
void OptionsDialog::setModel(OptionsModel *_model)
{
    ...
    connect(ui->quantumSafeStaking, &QCheckBox::clicked, this, &OptionsDialog::showRestartWarning);
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->quantumSafeStaking, OptionsModel::QuantumSafeStaking);
