...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, XEPUnits::SeparatorStyle separators=XEPUnits::SeparatorStyle::STANDARD) const;
