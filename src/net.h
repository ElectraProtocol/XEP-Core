...
/** Maximum length of incoming protocol messages (no message over 40 MB is currently acceptable). */
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on XEP’s Peer-to-Peer Network")
